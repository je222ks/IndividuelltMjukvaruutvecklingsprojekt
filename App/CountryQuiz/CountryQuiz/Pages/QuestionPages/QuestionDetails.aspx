...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:FormView ID="QuestionFormView" runat="server"
        ...
        <ItemTemplate>
            <div id="info">
                <div>
                    <label for="QuestionTitle" class="head">Question</label>
                ...
                <div>
                    <label for="AnswerOption1" class="head">Answer : </label>
                ...
                <div>
                    <label for="AnswerOption2" class="head">Answer : </label>
                ...
                <div>
                    <label for="AnswerOption3" class="head">Answer : </label>
                ...
                <div>
                    <label for="AnswerOption4" class="head">Answer : </label>
                ...
                <div>
                    <label for="CorrectAnswer" class="head">Correct Answer to the question : </label>
                ...
                <div>
                    ...
                    <asp:LinkButton runat="server" CommandName="Delete" Text="Remove Question" CssClass="cmdBtn" OnClientClick='<%# String.Format("return confirm(\"Are you sure you would like to remove the question, {0}?\")", Item.QuestionTitle) %>'></asp:LinkButton>
                </div>
            </div>
        </ItemTemplate>
        <EditItemTemplate>
